        ...
        <table class="table table-responsive-sm table-borderless table-hover table-striped">
            ...
            <tbody>
                ...
                @endif
                        ...
                        <td class="pt-3">
                            @if ($site->relink != false)
                                <a href="{{ $site->relink }}" target="_blank">
                                    <span style="cursor:pointer;color:#000;">{{ $site->relink }}</span>
                                </a>
                            @else
                                <span style="color: darkgrey;font-style: italic;">Не указано</span>
                            @endif
                        </td>
